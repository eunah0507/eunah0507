...
<h2>🫡 인턴 경력</h2>
<ul>
  <li><code>2025.10.13 ~ 2026.01.07</code> | 플랫폼개발R&D본부 인턴 연구원 | <strong>주식회사 코드프레소</strong></li>
  <ul>
    ...
    <ul>
      ...
      <li>운영 중 발생한 예외 및 데이터 불일치 이슈 점검 및 수정</li>
    </ul>
  </ul>
  ...
  <ul>
    ...
    <ul>
      <li>11개 코스, 56개 스킬 규모의 문서·실습형 학습 콘텐츠 설계 및 제작</li>
      <li>DTO·Controller 등 레이어 단위 실습 코드 구현 및 동작 검증</li>
    </ul>
